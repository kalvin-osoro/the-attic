...
public class ProfileActivity extends AppCompatActivity {
    ...
    //Declare an Instance of URI for getting the image from our phone, initialze it to null
    ...
    //startActivityForResult() method will require two rguments the intent and the request code
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //We want to set the profile for specific, hence get the users id of the current user and 
        ...
        //specific user reference using the userID
        ...
        //set on clickListener on the image button so as to allow users to pick their profile
        //photo from thier gallery
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //since we need results, use the method startActivityForRsult() and pass the intent and
        ...
        //THIS ON DATABASE REFERENCE FOR A SPECIFIC USER
        doneBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(name)&& profileImageUri !=null){
                    //create Storage reference node, inside prfile_image storage refrrecne where you will
                    ...
                    profileImagePath.putFile(profileImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            //if the upload of the profile image ws successful get the download url
                            if (taskSnapshot.getMetadata()!=null){
                                if (taskSnapshot.getMetadata().getReference()!=null){
                                    //get the download url fro your storage, use the methods getStorage() and
                                    //getDownloadUrl()
                                    Task<Uri> result=taskSnapshot.getStorage().getDownloadUrl();
                                    //call the method addOnSuccessListener to determine if we got the donload url
                                    result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            mDatabaseUser.push();
                                            //call the method addValueEventListener to publish the additions in the databse
                                                    ...
                                                    mDatabaseUser.child("profilePhoto").setValue(profileImage).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            if (task.isSuccessful()){
                                                                //show a toast to indicate the profile was upated
    ...
    @Override
    //override this method to get profile image set it in the image button view
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        super.onActivityResult(requestCode, resultCode, data);

        if (requestCode == GALLERY_REQ && resultCode == RESULT_OK){
            //get the image selecteg by the user
